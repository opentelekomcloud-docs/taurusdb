...
.. table:: **Table 3** Request body parameter
   ...
   | Parameter        | Mandatory | Type                                                                                                                         | Description                     |
   +==================+===========+==============================================================================================================================+=================================+
   | sql_filter_rules | Yes       | Array of :ref:`NodeSqlFilterRuleInfo <setsqlfilterrule__en-us_topic_0000001374871969_request_nodesqlfilterruleinfo>` objects | SQL throttling rules for nodes. |
   +------------------+-----------+------------------------------------------------------------------------------------------------------------------------------+---------------------------------+
...
.. table:: **Table 4** NodeSqlFilterRuleInfo
   ...
   +-----------+-----------+----------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------+
   | rules     | Yes       | Array of :ref:`NodeSqlFilterRule <setsqlfilterrule__en-us_topic_0000001374871969_request_nodesqlfilterrule>` objects | SQL throttling rules. The **sql_type** value must be unique. |
   +-----------+-----------+----------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------+
...
.. table:: **Table 5** NodeSqlFilterRule
   ...
   |                 |                 |                                                                                                                                    | -  INSERT             |
   +-----------------+-----------------+------------------------------------------------------------------------------------------------------------------------------------+-----------------------+
   | patterns        | Yes             | Array of :ref:`NodeSqlFilterRulePattern <setsqlfilterrule__en-us_topic_0000001374871969_request_nodesqlfilterrulepattern>` objects | SQL throttling rules. |
   +-----------------+-----------------+------------------------------------------------------------------------------------------------------------------------------------+-----------------------+
...
.. table:: **Table 6** NodeSqlFilterRulePattern
   ...
   | Parameter       | Mandatory | Type    | Description                                                                                                                                                                                                                                           |
   +=================+===========+=========+=======================================================================================================================================================================================================================================================+
   | pattern         | Yes       | String  | SQL throttling rule. A rule can consist of up to 128 keywords. The keywords are separated by tildes (~), for example, **select~from~t1**. The rule cannot contain backslashes (\\), commas (,), or double tildes (~~). It cannot end with tildes (~). |
   +-----------------+-----------+---------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
.. table:: **Table 7** Response body parameter
   ...
   ========= ====== ====================================================
   job_id    String ID of the task for configuring SQL throttling rules.
   ========= ====== ====================================================
