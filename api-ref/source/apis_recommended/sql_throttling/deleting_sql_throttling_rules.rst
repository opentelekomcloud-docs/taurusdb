...
This API is used to delete SQL throttling rules. Before calling this API:
...
.. table:: **Table 3** Request body parameter
   ...
   | Parameter        | Mandatory | Type                                                                                                                                        | Description                     |
   +==================+===========+=============================================================================================================================================+=================================+
   | sql_filter_rules | Yes       | Array of :ref:`DeleteNodeSqlFilterRuleInfo <deletesqlfilterrule__en-us_topic_0000001323271972_request_deletenodesqlfilterruleinfo>` objects | SQL throttling rules for nodes. |
   +------------------+-----------+---------------------------------------------------------------------------------------------------------------------------------------------+---------------------------------+
...
.. table:: **Table 4** DeleteNodeSqlFilterRuleInfo
   ...
   +-----------+-----------+-------------------------------------------------------------------------------------------------------------------------------------+-----------------------+
   | rules     | Yes       | Array of :ref:`DeleteNodeSqlFilterRule <deletesqlfilterrule__en-us_topic_0000001323271972_request_deletenodesqlfilterrule>` objects | SQL throttling rules. |
   +-----------+-----------+-------------------------------------------------------------------------------------------------------------------------------------+-----------------------+
...
.. table:: **Table 5** DeleteNodeSqlFilterRule
   ...
   |                 |                 |                  | -  INSERT             |
   +-----------------+-----------------+------------------+-----------------------+
   | patterns        | Yes             | Array of strings | SQL throttling rules. |
   +-----------------+-----------------+------------------+-----------------------+
...
.. table:: **Table 6** Response body parameter
   ...
   ========= ====== =================================================
   job_id    String ID of the task for deleting SQL throttling rules.
   ========= ====== =================================================
