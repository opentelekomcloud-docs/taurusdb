...
project = 'TaurusDB'
otcdocs_repo_name = 'opentelekomcloud-docs/taurusdb'
# Those variables are required for edit/bug links

# Those variables are needed for indexing into OpenSearch
otcdocs_doc_environment = 'public'
otcdocs_doc_link = '/taurusdb/api-ref/'
otcdocs_doc_title = 'API Reference'
otcdocs_doc_type = 'api-ref'
otcdocs_service_category = 'database'
otcdocs_service_title = 'TaurusDB'
otcdocs_service_type = 'taurusdb'
...
html_title = "TaurusDB - API Reference"
...
latex_documents = [
    ('index',
     'taurusdb-api-ref.tex',
    u'TaurusDB - API Reference',
